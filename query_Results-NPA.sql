...
WHERE (((IncidentDetails.Area) Like forms!reportsmenu!area) And ((IncidentDetails.Date) Between forms!reportsmenu!from And forms!reportsmenu!to) And ((IncidentDetails.Result)="NPA"));
