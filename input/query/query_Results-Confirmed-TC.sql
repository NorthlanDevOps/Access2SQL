...
WHERE (((IncidentDetails.SubArea) Like "*Town Centre*") And ((IncidentDetails.Date) Between forms!reportsmenu!from And Forms!reportsmenu!to) And ((IncidentDetails.Result)="Confirmed Incident")) Or (((IncidentDetails.SubArea) Like "*Shopping Area*") And ((IncidentDetails.Date) Between forms!reportsmenu!from And Forms!reportsmenu!to) And ((IncidentDetails.Result)="Confirmed Incident"));
