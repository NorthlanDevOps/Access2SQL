...
WHERE (((IncidentDetails.Result)="cautioned" Or (IncidentDetails.Result)="apprehended") And ((IncidentDetails.Date)>=#1/1/2007# And (IncidentDetails.Date)<=Date()) And ((IncidentDetails.SubArea)=Forms!search!subarea))
