SELECT IncidentDetails.IncidentType, IncidentDetails.Description, IncidentDetails.Action, IncidentDetails.Area, IncidentDetails.SubArea, IncidentDetails.Date, IncidentDetails.Time, IncidentDetails.CameraNo, IncidentDetails.ID, IncidentDetails.NoAppCautions, IncidentDetails.Result
